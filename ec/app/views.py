...
def home(request):
    brands = [
        ('CAFÉ', 'app/images/product/cafe.png', 'ML'),
        ('PANELA', 'app/images/product/panela.png', 'CR'),
        ('AGUACATE', 'app/images/product/aguacate.png', 'LS'),
        ('PLÁTANO', 'app/images/product/platano.png', 'MS'),
        ('CAÑA', 'app/images/product/caña.png', 'PN'),
        ('PAPA', 'app/images/product/papa.png', 'GH'),
